...
(async () => {
  ...
  await huskyHook
    ...
    .addCommand(
      CommandHookFactory.createHookCommand('pre-commit', 'echo your shell script goes here.'),
    )
    .addCommand(
      CommandHookFactory.createHookCommand('pre-commit', 'echo your second shell script goes here.'),
    )
    .addCommand(
      CommandHookFactory.createHookCommand('pre-push', 'echo your shell script goes here.'),
    )
    .runAllCommands();
})();
