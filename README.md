# Welcome to @husky-hook-starter/core 👋
...
```sh
yarn add @husky-hook-starter/core
```
...
2. Inside your project run `yarn add @husky-hook-starter/core ts-node@10.3.0`
...
![](misc/husky-hook-starter-process.png)
...
If you need to install husky library from a folder that does not contains any .git folder, please check the example in the [file](library/script/src/create-hooks.ts).
...
1. Import all required class `import { CommandHookFactory, HuskyRunnerFactory } from '@husky-hook-starter/core';`
